...
export const getFallbackFactCheck = (title: string, authorVerified?: boolean): FactCheckReport => ({
  ...
  sources: [
    {
      title: 'Publication au Journal Officiel & Décrets d’Application',
      publisher: 'Secrétariat Général du Gouvernement & Journal Officiel',
      documentType: 'official_gazette',
      documentLabel: 'JO N° 2026-04/BURKINA-FASO',
      url: 'https://www.sig.bf',
      verifiedBadge: true,
      attachmentAuthSeal: 'SEAL-JO-2026-OK',
    },
    {
      title: 'Rapport d’Enquête Documentaire & Données Statistiques Nationales',
