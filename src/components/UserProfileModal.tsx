...
export const UserProfileModal: React.FC<UserProfileModalProps> = ({ onClose }) => {
  ...
  const roleBadgeColor =
    user.role === 'admin'
      ...
      : 'bg-[#0a1024] text-blue-300 border-blue-500/40 shadow-[0_0_8px_rgba(0,150,255,0.15)]';
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4 -mt-12 sm:-mt-14 mb-3">
                ...
                <div className="relative shrink-0 group">
                  ...
                  <button
                    ...
                    className="absolute -bottom-1 -right-1 p-2 bg-gradient-to-r from-blue-600 to-cyan-400 hover:from-blue-500 hover:to-cyan-300 text-white rounded-full shadow-[0_0_12px_rgba(0,210,255,0.4)] border-2 border-[#0b0e1a] transition-all cursor-pointer"
                  >
                ...
                <div className="mt-3 p-2.5 bg-[#141933] border border-cyan-500/40 rounded-xl flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    <button
                      ...
                      disabled={avatarUploading}
                      className="px-2.5 py-1 bg-gradient-to-r from-blue-600 to-cyan-400 hover:from-blue-500 hover:to-cyan-300 text-white text-xs font-bold rounded-lg transition-colors flex items-center gap-1 cursor-pointer shadow-[0_0_12px_rgba(0,210,255,0.3)]"
                    >
                      {avatarUploading ? (
                        <>
